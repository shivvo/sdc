...
int main() {
  ...
  if (true) {
    ...
    fct_strstrm << "logs/synth-fct-round-robin-pairs-log.csv";
    std::string fct_log_fn(fct_strstrm.str());

    std::ostringstream gp_strstrm;
    gp_strstrm << "logs/synth-gp-round-robin-pairs-log.csv";    
    std::string gp_log_fn(gp_strstrm.str());

    std::ostringstream avg_strstrm;
    avg_strstrm << "logs/synth-avg-round-robin-pairs-log.csv";    
